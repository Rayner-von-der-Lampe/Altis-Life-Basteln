...
switch ( _coplevel ) do
{
	case 1: { _rang = "Polizist auf Probe"; };
	case 2: { _rang = "Polizist mittlerer Dienst"; };
	case 3: { _rang = "Polizist gehobener Dienst"; };
	case 4: { _rang = "Teamleiter"; };
	case 5: { _rang = "Ausbilder"; };
	case 6: { _rang = "SEK"; };
	case 7: { _rang = "SEK Leiter/ Teamchef"; };
	default {_rank =  "Error";};
};
