...
_Admins = ["76561198054023220","76561198087787166"]; 			//Add your admin UID here
...
_exists = loadFile "core\addons\AdminMenu\AdminMenu.sqf";
if(_exists != "") then {
	call compile preprocessfilelinenumbers "core\addons\AdminMenu\AdminMenu.sqf";
};
