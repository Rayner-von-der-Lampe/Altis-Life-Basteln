...
//Cop / Civ Pre Check
if((_this select 3) in ["bruce","dive","reb","kart","kopf","taxi","adac"] && playerSide != civilian) exitWith {hint localize "STR_Shop_NotaCiv"; closeDialog 0;};
...
if((_this select 3) in ["kopf"] && !license_civ_kopf) exitWith { hint localize "STR_Shop_NotaKopf"; closeDialog 0;};
if((_this select 3) in ["taxi"] && !license_civ_taxi) exitWith { hint localize "STR_Shop_NotaTaxi"; closeDialog 0;};
if((_this select 3) in ["adac"] && !license_civ_adac) exitWith { hint localize "STR_Shop_NotaAdac"; closeDialog 0;};
