...
_clothes = switch (life_clothing_store) do
{
	...
	case "kopf": {[_selection] call life_fnc_clothing_kopf;}; //Kopfgeldjäger
	case "taxi": {[_selection] call life_fnc_clothing_taxi;}; //Taxi
	case "adac": {[_selection] call life_fnc_clothing_adac;}; //Adac
};
