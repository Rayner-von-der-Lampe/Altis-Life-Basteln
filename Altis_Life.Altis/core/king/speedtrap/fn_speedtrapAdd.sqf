...
life_action_speedtrapDeploy = player addAction["Platziere Blitzer",{if(!isNull king_speedtrap) then {detach king_speedtrap; king_speedtrap = ObjNull;}; player removeAction life_action_speedtrapDeploy; life_action_speedtrapDeploy = nil;},"",999,false,false,"",'!isNull king_speedtrap'];
